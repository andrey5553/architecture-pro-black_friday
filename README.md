...
[Task10-01: Классификация данных по критичности и обоснование на переход с Cassandra (гибрид)](/schemas/Task10/ADR-10-01.md)
[Task10-02: Детальная модель данных с оптимальной стратегией партиционирования](/schemas/Task10/ADR-10-02.md)
[Task10-03: Стратегии обеспечения целостности данных для сущностей системы](/schemas/Task10/ADR-10-03.md)
